...
import EvacuationMapComponent from '../components/EvacuationMapComponent'; // Ensure this component exists
import HeatMapComponent from '../components/HeatMapComponent'; // Ensure this component exists
import { useLocation } from 'react-router-dom';
import { CrowdDensityChart } from '@/components/CrowdDensityChart'; // Import the CrowdDensityChart component
        ...
        <main className="flex-grow pt-24 pb-16">
          <div className="container mx-auto px-4">
            <div className="mb-8">
              ...
              >
                Emergency Management for {eventName || 'Event'}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Left Column - Evacuation Routes and Crowd Density Chart */}
              <div className="lg:col-span-2">
                ...
                >
                  ...
                  <div className="aspect-video bg-secondary/50 rounded-lg overflow-hidden">
                    <EvacuationMapComponent /> {/* Ensure this component is implemented */}
                  </div>
                  ...
                  {/* Crowd Density Chart */}
                  <div className="mt-8">
                    <h3 className="text-xl font-bold mb-4">Crowd Density Over Time</h3>
                    <CrowdDensityChart roomId="room1" /> {/* Pass roomId here */}
                  </div>
                </motion.div>
              </div>

              {/* Right Column - Heatmap, Current Status, and Emergency Contacts */}
              <div className="space-y-8">
                ...
                >
                  <HeatMapComponent /> {/* Ensure this component is implemented */}
                </motion.div>
